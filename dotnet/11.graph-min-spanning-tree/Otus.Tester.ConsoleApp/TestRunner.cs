    ...
    public class TestRunner
    {
        ...
        public void Run()
        {
            ...
            while (true)
            {
                ...
                if (!File.Exists(inputFile) || !File.Exists(outputFile)) break;
                ...
                if (!isStopped) PrintTestResult(count, testRunner.Result, timer.Elapsed);
        ...
        private Tuple<bool, string[], string[]> ExecuteTest(string inputFile, string outputFile)
        {
            ...
            if (expected.Length != actual.Length) return new Tuple<bool, string[], string[]>(false, expected, actual);
